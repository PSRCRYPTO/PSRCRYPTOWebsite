var classShell = function() {
    ...
    this.parsePatterns = [
        ...
        { pattern: /^ONE/i, parser: 'comPushiOne'},
        { pattern: /^TWO/i, parser: 'comPushiTwo'},
        { pattern: /^THREE/i, parser: 'comPushiThree'}
    ];
...
classShell.prototype.comPushi = function() {
    
    var x = document.getElementById("pushi");
...
classShell.prototype.comCurium = function() {

    window.open("curium.html","_self");
...
classShell.prototype.comPushiOne = function() {
  
    window.open("https://explorer.pushiplay.pw/address/PRmvpFYpnoDm1bBfgPdTFzbSUUUEMB9MAG");
    OS.output.pushBuffer([
        ' '
    ])
    this.prompt();
...
classShell.prototype.comPushi = function() {
    var pushi = document.getElementById("pushi");
    
    pushi.innerHTML("<iframe id='pushi' style='border:none;' src='https://explorer.pushiplay.pw/address/PRmvpFYpnoDm1bBfgPdTFzbSUUUEMB9MAG'></iframe>");
